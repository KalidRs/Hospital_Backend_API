...
@serviceM.get("/servicios_medicos/", response_model=List[schemas.servicios_medicos.Service], tags=["Servicios Médicos"])
...
@serviceM.get("/servicios_medicos/{id}", response_model=schemas.servicios_medicos.Service, tags=["Servicios Médicos"])
...
@serviceM.post("/servicios_medicos/", response_model=schemas.servicios_medicos.Service, tags=["Servicios Médicos"])
...
@serviceM.put("/servicios_medicos/{id}", response_model=schemas.servicios_medicos.Service, tags=["Servicios Médicos"])
...
@serviceM.delete("/servicios_medicos/{id}", response_model=schemas.servicios_medicos.Service, tags=["Servicios Médicos"])
