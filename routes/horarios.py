...
def obtener_horario(id: str, db: Session = Depends(get_db)):
...
def actualizar_horario(id: str, horario: schemas.HorarioUpdate, db: Session = Depends(get_db)):
...
def eliminar_horario(id: str, db: Session = Depends(get_db)):
