...
def obtener_puesto(id: str, db: Session = Depends(get_db)):
...
def actualizar_puesto(id: str, puesto: schemas.PuestoUpdate, db: Session = Depends(get_db)):
...
def eliminar_puesto(id: str, db: Session = Depends(get_db)):
